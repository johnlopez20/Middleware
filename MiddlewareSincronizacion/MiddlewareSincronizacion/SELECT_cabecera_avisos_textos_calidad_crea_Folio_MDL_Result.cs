...
namespace MiddlewareSincronizacion
{
    ...
    public partial class SELECT_cabecera_avisos_textos_calidad_crea_Folio_MDL_Result
    {
        public int id_catc { get; set; }
        public string folio_sam { get; set; }
        public string num_notificacion { get; set; }
        public string numero_correlativo_medida_mante { get; set; }
